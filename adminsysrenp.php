...
<input type="text" id="myInput" onKeyUp="myFunction()" placeholder="Search for Pass Id.."><br>
<p></p>
...
<th>Sl.no</th>
  ...
  $sql ="SELECT name,passid,passtype,rendate,fromarea,toarea,institution,aadhar,address,pincode,uname FROM renpass";
