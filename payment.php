...
<p id="credit">Card no</p><input type="number" class="credit" min='100000000000' id='credit'><br><br>
...
<?php
   ...
   if($conn->connect_error)
 {
   die("connection failed" . $conn->connect_error);
	...
	$ms="Registration Payment sucessfull Generating Online Buss Pass" ;
	
	$sql="INSERT INTO regpass(name,age,passid,passtype,uname,regdate,fromarea,toarea,institution,aadhar,address,pincode) VALUES('$name','$age','$id','$passty','$uname','$dat','$from','$to','$ins','$aadhar','$address','$pin')";
 ...
 if($conn->query($sql) === TRUE)
   {   
        ...
        echo "<script type='text/javascript'>
	           location.href='http://localhost/buss%20pass/displayreg.php';
			   alert('$ms');
		      </script>"; 	
   }
 }  
