...
<input type="text" id="myInput" onKeyUp="myFunction()" placeholder="Search for Renewal Date.."><br>
<p></p>
...
<th>Sl.no</th>
  ...
  $sql ="SELECT name,passid,passtype,rendate,fromarea,toarea,institution,aadhar,address,pincode,uname FROM renpass WHERE passid = '$id'";
